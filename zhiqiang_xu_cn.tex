...
\cventry{2019.10 -- 至今}{驱动系统架构师}{上海上汽集团商用车技术中心}{上海市}{}{
  工作内容：汽车AVN系统通信及控制架构的设计定义，重构工作。
  \newline{}
  主要工作：
  \begin{itemize}
  \item SV5101自建项目，开发模块梳理。
  \end{itemize}  
}
...
\cvdoubleitem{201410613796.8}{一种移动终端及其虚拟光驱的实现方法}{发明}{唯一发明人}
\cvdoubleitem{201210368281.7}{一种耳机接口装置及基于所述耳机接口装置的控制方法}{发明}{唯一发明人}
\cvdoubleitem{201510745100.1}{一种密钥加密方法及系统、电子设备}{发明}{唯一发明人}
