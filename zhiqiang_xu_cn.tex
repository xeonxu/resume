...
\section{简介}
\cvlistitem{本科学士学位。18 年嵌入式软件开发，2 年管理经验}
\cvlistitem{7 年车载项目，7 年手机研发， 4 年机器人研发。}
\cvlistitem{熟悉 Linux 开发环境，内核驱动开发及调试，擅长使用脚本对系统集成和开发环境进行自动化。}
\cvlistitem{熟练使用 C 语言，Bash 脚本，Git 版本管理，以及能够基于Docker做一些开发和应用。作为爱好，喜欢 lisp 和它的方言语言。}
...
\cventry{2022.04 -- 至今}{系统软件主任工程师}{上海极氪蓝色新能源技术有限公司}{上海市}{}{
  工作内容：座舱系统SOA通信中间件软件架构及诊断中间件软件架构设计和开发
  \newline{}
  主要工作：
  \begin{itemize}
  \item 极氪智能座舱SOA通信平台中间件架构设计和开发
    \begin{itemize}
    \item 基于开源套件，为极氪2.x平台车型开发SOA通信组件。
    \item 基于Docker构建统一的开发编译及运行环境，确保目标版本编译生成时的一致性。
    \item 完成单机下仿真SOMEIP 跨设备通信的能力及单步调试代码的能力。
    \item 完成可以将excel 格式服务矩阵文件转换为对应服务的软件工程模板，减小人为干预，极大提高SOA 服务的工程化效率。
    \item 完成SOA 组件的SDK 化，并实现多操作系统（ Linux ，QNX，Android等）的支持。从而实现SOA通信组件的平台化能力，以及服务并行开发的能力。
    \item 完成Wireshark的SOMEIP 服务以太网报文解析插件。该插件通过导入矩阵定义文件，将SOMEIP 的以太网抓包报文解析为服务接口及对应的数据内容。该能力在SOA 服务开发和联调工作中，极大地提升了对手件双方在服务数据确认上的效率。
    \item 设计多种业务联调方案和自动化工具，结
      合ADB，ROS路由器，等跨领域民用产品，可实现测试台架的快速搭建和联调能力。
    \end{itemize}
  \item 极氪智能座舱诊断服务平台中间件架构设计和开发
    \begin{itemize}
    \item 3.0平台以太网诊断中间件架构设计
    \item 3.0平台以太网诊断中间件功能开发
    \item 3.0平台以太网诊断服务开发
    \item 基于Docker实现多平台支持的以太网诊断中间件开发平台，包括提供SDK输出，单机联调验证，抓包分析等功能。
    \end{itemize}
  \item 极氪智能座舱以太网诊断升级服务设计和开发
    \begin{itemize}
    \item 以太网诊断升级应用的架构设计及软件工程搭建
    \item 移植之前项目中升级服务的相关逻辑，并基于新架构完成对应重构工作。实现更清晰的功能抽象和模块划分，并提高可维护性。
    \end{itemize}
  \end{itemize}
}
...
\cventry{2018.06 -- 2019.09}{高级软件工程师}{上海云绅智能科技有限公司}{上海市}{}{
  ...
  \item 制定机器人内部路由器部署方案，实现4G和wifi双上行自动链路切换功能，同时支
    持VPN拨号至公司内网做业务维护，另外还支持和不同网段的的机内三方设备互联互通
  \item 为全息项目开发基于UWB的室内定位方案
  \item 标准化工控机生产和部署，开发相关生产工具，实现无人为干预下5分钟生产部署一
    台工控系统的能力
