...
\cventry{2022.04 -- Present}{Senior Software Engineer}{Shanghai Zeekr Blue New Energy Technology Co., Ltd}{Shanghai}{}{
  Responsibilities: Architecture design and development of the SOA communication middleware and diagnostic middleware for for automotive cockpit systems.
  \begin{itemize}
  \item Zeekr Intelligent Cockpit SOA Communication Platform Middleware Architecture Design and Development
    \begin{itemize}
    \item Developed SOA communication components for Zeekr’s 2.x platform vehicles based on open-source suites.
    \item Built a unified development and compilation environment based on Docker to ensure consistency across target version builds.
    \item Achieved simulation of SOMEIP cross-device communication and single-step debugging capabilities on a standalone machine.
    \item Developed a tool to convert Excel-based service matrix files into corresponding software engineering templates, reducing manual intervention and significantly improving the efficiency of SOA service engineering.
    \item Developed the SDK for SOA components, supporting multiple operating systems (Linux, QNX, Android, etc.), enabling platform-level SOA communication components and parallel service development.
    \item Created a Wireshark plugin for SOMEIP Ethernet packet analysis, which parses SOMEIP Ethernet packet captures into service interfaces and corresponding data contents by importing matrix definition files. This significantly improved the efficiency of service data confirmation during SOA service development and integration.
    \item Designed various business integration solutions and automation tools. Combined with ADB, ROS routers, and other cross-domain consumer products, these tools enabled rapid test bench setup and integration.
    \end{itemize}
  \item Zeekr Intelligent Cockpit Diagnostic Service Platform Middleware Architecture Design and Development
    \begin{itemize}
      \item Designed the Ethernet diagnostic middleware architecture for the 3.0 platform.
      \item Developed Ethernet diagnostic middleware functionality for the 3.0 platform.
      \item Developed Ethernet diagnostic services for the 3.0 platform.
      \item Created a Docker-based development platform that supports multi-platform Ethernet diagnostic middleware, including SDK output, single-machine integration testing, and packet capture analysis.
    \end{itemize}
  \item Zeekr Intelligent Cockpit Ethernet Diagnostic Upgrade Service Design and Development
    \begin{itemize}  
    \item Designed the architecture and established the software engineering framework for the Ethernet diagnostic upgrade application.
    \item Refactored and integrated logic from previous projects’ upgrade services into the new architecture, achieving clearer functional abstraction, improved modularization, and enhanced maintainability
    \end{itemize}
  \end{itemize}
}
