...
\begin{itemize}
 \item Sensor development
  \begin{itemize}
  \item implement rt-thread's CAN driver for STM32.
  \item Develop ultrasonic, anti-colllision, anti-falling sensors. Report sensors' infomations by CAN bus.
  \item Implement CAN bus based OTA function for sensors.
  \end{itemize}
