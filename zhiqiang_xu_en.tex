...
\section{SUMMARY}
\cvlistitem{B.E. with 15 years software develop experience. }
\cvlistitem{Especially, 14 years embeded software develop exprience. Including 3 more years on vehicle related projects development, 7.5 years on developing mobile phone, and 3.5 years on robot development.}
\cvlistitem{Excellent in C, bash, linux, rt-thread, version control and docker operation.}
\cvlistitem{Be familiar with software design, problem solving and debuging skills.}
\cvlistitem{Experience on ROS and docker technic. STM32 based sensors implementation.}
...
\begin{itemize}
 \item Sensor development
  ...
  \item ultrasonic, anti-colllision, anti-falling sensors development.
  \item Sensor's firmware upgrading over CAN method implementation.
  \end{itemize}
 \item Robot control system
  \begin{itemize}
  \item Package ROS running enviroment by docker image.
...
\cventry{2016.07 -- 2018.05}{Senior Embeded Software Engineer}{Shanghai clever mrobot technologies Co., Ltd. }{Shanghai}{}{Responsibilities: Robotic development
\begin{itemize}
...
\cventry{2010.06 -- 2016.06}{Embeded Software Engineer}{Shanghai Phicomm. Inc.}{Shanghai}{}{Responsibilities: Mobile phone development
\begin{itemize}
 \item Android Smartphone project
  \begin{itemize}
  \item On Marvell PXA968 platform. Sensor driver and PMIC driver development.
  \item Qualcomm MSM7x27/MSM8x25/MSM8x25Q platform. PMIC module development. Develop environment optimization: geomagnetic debug method optimization, TP fw upgrade method. Dual-way charging method implementationg based on smb358. Batch review tool for gerrit.
  \item Qualcomm MSM8x10/8x12/8x26/8x16/8994/8909 platform. PMIC module, battery charactorization.
  \item Package all-in-one environment to a single self-uncompressable file for convinient quick setting for newbie developers under windows and linux.
  \item Package Android compile environment by docker technic to standardize compile environment.
  \item Optimize android complilation efficiency by using ditcc and ccache.
  \end{itemize}
\item MStar and MTK feature phone development
   \begin{itemize}
  \item MMI custimization, SP porting for customer.
  \item Scripting for auto release.
  \end{itemize}
\end{itemize}
}
\cventry{2009.10 -- 2010.06}{Embeded software engineer}{Shanghai iBingo network technology Co., Ltd.}{Shanghai}{}{Responsibilities: Develop dynamic theme and screen saver for feature phone (iShow theme system).
  \begin{itemize}
...
\cventry{2008.11 -- 2009.10}{Embeded Software Engineer}{Shanghai Dragontec Group}{Shanghai}{}{Responsibilities:Japanese outsourcing job.
  \begin{itemize}
...
\cventry{2007.05 -- 2008.06}{Embeded Software Engineer}{Hitachi ICS}{Hitachi}{}{Responsibilities: Development of IVI for Cadillac CTS 08 and 09.
  \begin{itemize}
