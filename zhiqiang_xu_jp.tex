...
\cvitem{}{
  \begin{itemize}
  \item １０年ソフトウェア開発経験
  \item ８年にわたる、組込ソフトウェア開発経験。まだは、７年モーベルフンを開発で、５年Linuxドライバー関連仕事をした。特に、Qualcomm社商品の開発経験を持ってる。５年電池充電マネージメント経験がある。
  \item １年にわたる、二つJAVAプロジェクト開発経験。C言語とLinuxが上手で、カーネルドライバーの開発とデバッグも無碍です。
  \item ２年ソフトウェアプロジェクトを務めて、進捗/人員管理まで各方面の経験。
